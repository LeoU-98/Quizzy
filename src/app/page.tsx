export default function App() {
  return (
    <div className="flex h-screen w-full items-center justify-center bg-black">
      <div className="container mx-auto flex items-center bg-red-500">
        <Filters />

        <div className="bg-blue-500">Question </div>
      </div>
    </div>
  );
}
...
function Filters() {
  return (
    <form className="flex flex-col gap-5 rounded-2xl bg-gradient-to-tl from-violet-600 to-purple-800 p-5">
      <div>
